    ...
    <div className="min-h-screen px-8 py-16 bg-black">
      ...
      <div className="grid gap-8 items-start justify-center mt-8">
        <div className="relative group">
          ...
          <div className="absolute -inset-0.5 bg-gradient-to-r from-pink-600 to-purple-600 rounded-lg blur opacity-75 group-hover:opacity-100 transition-all duration-300"></div>
          <button className="relative px-7 py-4 rounded-lg leading-none flex items-center divide-x bg-black">
            <span className="flex space-x-3 items-center">
              ...
              <span className="text-gray-100 font-bold pr-4 group-hover:text-purple-500">Deep Design Web
              </span>
            </span>
